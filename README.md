...
# \- \*\*App:\*\* https://page-pulse-self.vercel.app/

# \- \*\*API:\*\* https://page-pulse-api-1fzx.onrender.com

# 

# Note: the backend is on Render's free tier, so it spins down after

# inactivity. The first request after a while can take 30-50 seconds

# to wake up — that's expected, not a bug.
...
# static server. Before deploying, update `API\_BASE\_URL` at the top of
